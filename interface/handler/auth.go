...
type AuthHandler interface {
	GetLogin() echo.HandlerFunc
	GetCallback() echo.HandlerFunc
}
...
func (ah *authHandler) GetLogin() echo.HandlerFunc {
	return func(c echo.Context) error {
		oc := service.NewAuthService()
...
func (ah *authHandler) GetCallback() echo.HandlerFunc {
	return func(c echo.Context) error {
